...
import { nbaTeams, type ActionMode, type NBATeam } from "@/data/nba-teams"
...
export default function NBAWheelPage() {
  ...
  const handleAddManualTeam = useCallback((teamName: string) => {
    ...
    const customTeam: NBATeam = {
      ...
      city: "Custom City",
      league: "Eastern", // Default league
      division: "Atlantic", // Default division
      logo: "🏀", // Default logo
      primaryColor: "#666666", // Default color
      secondaryColor: "#999999", // Default color
      ...
      >
        ...
        <main className="w-full px-4 py-8 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <ToolPageTitle title="NBA Picker Wheel" toolType="nba-wheel" />
            <p className="text-gray-600">Pick a random NBA team by wheel</p>
          </div>
