...
export function DemonSlayerWheelPopularTemplates() {
  const pathname = usePathname()
  return <section id="ds-popular" className="mb-6 w-full scroll-mt-24" aria-labelledby="ds-popular-heading">
    <div className="mb-3 text-center sm:text-left"><h2 id="ds-popular-heading" className="text-lg font-bold text-slate-900 sm:text-xl">
      Popular Demon Slayer Wheels</h2>
      <p className="mt-1 text-sm text-slate-600">Ready-made character, Hashira, demon, breathing, Nichirin, and favorites templates.</p></div>
