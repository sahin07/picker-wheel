...
const PAGE_URL = `${HOME_SITE_URL}/game-instructions/sequence-match`
const PAGE_TITLE = "Sequence Match | Picker Wheel Game Instructions"
const PAGE_DESCRIPTION = "Learn Sequence Match—spin items in the correct order to win."
