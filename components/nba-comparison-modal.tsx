...
export default function NBAComparisonModal({ isOpen, onClose }: NBAComparisonModalProps) {
  ...
  const data = (wheel?.data as NBAWheelData) ?? ({ comparisonTeams: [] } as Pick<NBAWheelData, "comparisonTeams">)
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div className="text-center">
                <div className="text-lg font-bold text-purple-600">
                  {comparisonTeams.filter(t => t.league === 'Eastern').length}
                </div>
                <div className="text-xs text-gray-600">Eastern Conference</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-bold text-orange-600">
                  {comparisonTeams.filter(t => t.league === 'Western').length}
                </div>
