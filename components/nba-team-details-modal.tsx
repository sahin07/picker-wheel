...
interface NBATeamDetailsModalProps {
  isOpen: boolean
  onClose: () => void
  team: NBATeam | null
}

export default function NBATeamDetailsModal({ isOpen, onClose, team }: NBATeamDetailsModalProps) {
  if (!team) return null

  const getConferenceColor = (conference: string) => {
    return conference === "Eastern" ? "bg-blue-100 text-blue-800 border-blue-200" : "bg-red-100 text-red-800 border-red-200"
  }
  ...
  const getTeamAge = (founded: number) => {
    ...
    if (age >= 75) return <Badge className="bg-red-500 text-white"><Star className="w-3 h-3 mr-1" />Legacy Team ({age} years)</Badge>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-wrap gap-2">
                <Badge className={getConferenceColor(team.league)}>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-600">Arena:</span>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <span className="text-sm text-gray-600">Head Coach:</span>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-sm text-gray-600">NBA Championships</div>
                </div>
                <div className="text-center p-3 bg-gray-50 rounded-lg">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                <span className="text-sm text-gray-600">Conference History:</span>
                <div className="font-medium">
                  {team.league} Conference • {team.division} Division
                </div>
              </div>
