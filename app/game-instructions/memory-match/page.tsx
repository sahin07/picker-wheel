...
export const metadata = {
  title: 'Memory Match - How to Play | Picker Wheel Game Instructions',
  description: 'Learn how to play Memory Match mode in our Picker Wheel tool. Remember and match wheel results to test your memory skills!',
  keywords: 'picker wheel, memory match, memory game, brain training, wheel spinner, decision maker, cognitive skills',
}
